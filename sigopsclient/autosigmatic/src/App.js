...
import Operations from './pages/Project/Operations';
import createProject from './pages/Project/create/createProject.js';
import OperationDetails from './pages/Project/OperationDetails.js';
...
axios.defaults.baseURL = 'https://us-central1-automate-266501.cloudfunctions.net/api'
					...
					<Router>
						...
						<div className="container">
							<Switch>
								...
								<GuardedRoute exact path="/Projects/:ProjectId" component={Operations} />
								<GuardedRoute exact path="/Operations/:OperationId" component={OperationDetails} />
