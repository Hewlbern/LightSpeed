	...
	return (
		<Box p={5}>
			<Typography variant="body1" align="center">
				<strong>Is this a redesign?:</strong>
			</Typography>
			<Box py={4}>
		...
		<Box p={5}>
			<Table>
				<TableBody>
					<TableRow>
						<TableCell>
							<Typography>What Signal Software is this</Typography>
						</TableCell>
						<TableCell>
							<FormControl>
								<Select name="event" value={props.event} onChange={props.handleChange}>
									<MenuItem value="Yes">VC6</MenuItem>
									<MenuItem value="No">VC5</MenuItem>
					...
					<TableRow>
						<TableCell>
							<Typography>Have this design been requested due to safety reasons?</Typography>
						</TableCell>
						<TableCell>
							<FormControl>
					...
					<TableRow>
						<TableCell>
							<Typography>Is this a pedestrian operated intersection</Typography>
						</TableCell>
						<TableCell>
							<FormControl>
					...
					<TableRow>
						<TableCell>
							<Typography>What is the date of the signal change request?</Typography>
						</TableCell>
						<TableCell>
							<FormControl>
								<input
			...
			<Table>
				<TableBody>
					<TableRow>
						<TableCell>
							<Typography>
								Does the request contain appropriate information, including layout plan and signal information?
							</Typography>
						</TableCell>
						<TableCell>
							<FormControl>
					...
					<TableRow>
						<TableCell>
							<Typography>If no: Describe</Typography>{' '}
						</TableCell>
						<TableCell>
							<FormControl>
								<TextField
					...
					<TableRow>
						<TableCell>
							<Typography>Any other comments on the site?</Typography>
						</TableCell>
						<TableCell>
							<FormControl>
								<TextField
...
// 					<TableRow>
// 						<TableCell>
// 							<Typography>What output do you want??</Typography>
// 						</TableCell>
// 						<TableCell>
// 							<FormControl>
// 								<Select name="dec" value={props.dec} onChange={props.handleChange}>
// 									<MenuItem value="True">Excel</MenuItem>
// 									<MenuItem value="False">PDF</MenuItem>
// 								</Select>
// 							</FormControl>
// 						</TableCell>
// 					</TableRow>
